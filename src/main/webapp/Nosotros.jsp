			...
			<section class="products container" id="lista-1">
				<h2>
					<strong>Descubre nuestra historia, conoce nuestro equipo y
						<br> sumérgete en nuestro mundo de pasión y excelencia.
					</strong>
				</h2>
				<br> <img src="img/Conocenos.jpg" alt="Imagen no encontrada">
				<br>
				<br>
				<p>¡Bienvenido a nuestra dulce aventura pastelera! Únete a
					nosotros en este mundo lleno de delicias y sabores exquisitos.
					Descubre quiénes somos, nuestra pasión por la repostería y por qué
					para nosotros no solo somos una pastelería, ¡somos mucho más que
					eso! Forma parte de nuestro equipo de amantes de la repostería,
					...
					en el mundo de los postres. Sumérgete en nuestra cultura, donde la
					calidad, la variedad y el servicio al cliente son nuestra máxima
					prioridad. Cada dulce es seleccionado con esmero para ofrecerte lo
					mejor en cada bocado. ¡Déjate conquistar por nuestros deliciosos
