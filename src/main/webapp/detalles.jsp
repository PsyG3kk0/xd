						...
						<div class="row">
							<div class="col-md-6">
								<img class="img-fluid" alt='producto'
									src='img/tortas/${t.idtorta }.jpeg'>
							</div>
							<div class="col-md-6">
								<form action="venta" method="post">
									<div class="mb-3">
										<label class="form-label">Cod torta:</label> <strong>${t.idtorta}</strong>
										<a href="#"><img src="img/lupa.png" alt=""> </a>
									</div>
									<div class="mb-3">
										<label class="form-label">Nombre :</label> <strong>${t.nombret}</strong>
									</div>
									<div class="mb-3">
										<label class="form-label">Descripcion :</label> <strong>${t.descripcion}</strong>
									</div>
									<div class="mb-3">
									...
									<div class="mb-3">
										...
										<input type="number" value="1" name="cantidad"
												min="1" max="${t.stock }" class="text-center" >
										<span>Total disponible ${t.stock}</span>
									</div>
									<div class="mb-3">
										<button class="btn btn-primary">
											Agregar a la tienda <span
